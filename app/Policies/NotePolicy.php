 ...
 * enforced separately via the `project.member` middleware on every note
 * route (see routes/notes.php) — these rules only decide what a project
 * member may do to a specific note.
 */
class NotePolicy
{
    /**
