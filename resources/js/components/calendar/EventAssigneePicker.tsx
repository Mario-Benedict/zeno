      ...
      >
        {selectedMembers.length > 0 ? (
          selectedMembers.map((member) => (
            <span
              key={member.id}
              className="flex items-center gap-1 rounded-full bg-dark-surface-3 py-0.5 pr-2 pl-1.5 text-dark-primary"
            >
              <span
              ...
              return (
                ...
                >
                  <span
                    ...
                    style={{ backgroundColor: member.color }}
                  />
                  <span className="min-w-0 flex-1 truncate text-dark-primary">
                    {member.name}
                  </span>
                  {active && (
