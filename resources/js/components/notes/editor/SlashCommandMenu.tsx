...
const SlashCommandMenu = forwardRef<SlashCommandMenuHandle, SuggestionProps<SlashCommandItem>>((props, ref) => {
  ...
  return (
    <div className="max-h-80 w-72 overflow-y-auto rounded-lg border border-dark-border bg-dark-surface-2 p-1 shadow-lg [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
